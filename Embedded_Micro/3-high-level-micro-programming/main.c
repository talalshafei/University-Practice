...
#define BR_Calc ((F_CPU/16/BaudRate)-1) //Baud rate calculator as in slides equals 0x33 (51)
...
const unsigned char messages [][USER_TR_BUFFER_SIZE] = {
	...
	"\rMemory dump process finished \0",
	 ...
	 "\rEnter your option for Master Watchdog (& period):\rA-30ms\rB-250ms\rC-500ms \0",
